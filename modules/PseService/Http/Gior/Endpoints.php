...
final class Endpoints
{
    ...
    const BETA_TOKEN = 'https://app.validapse.com/api/auth/cpe/token';
    const BETA_GENERATE = 'https://app.validapse.com/api/cpe/generar-demo';
    const BETA_SEND = 'https://app.validapse.com/api/cpe/enviar-demo';
    const BETA_QUERY = 'https://app.validapse.com/api/cpe/consultar-demo';
